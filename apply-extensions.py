...
extensions_to_merge = ['ppp','location','requirements','budget','budget_project','documentation_details','metrics','risk_allocation','shareholders','related_process','finance','milestones','qualification','tariffs','performance-failures','signatories','charges','transaction_milestones','bids','milestone_documents']
