...
extensions_to_merge = ['ppp','location','requirements','budget','budget_project','documentation_details','metrics','risk_allocation','shareholders','related_process','equity_transfer_caps','finance','milestones','qualification','tariffs']
