...
* [#725](https://github.com/open-contracting/standard/pull/725) Add examples to the description of the 'environmentalImpact' code in the `documentType` codelist. Add 'priorInformationNotice' to `documentType`, 'CUCOP' to `itemClassificationScheme`, 'interestedParty' to `partyRole`, 'tender' to `relatedProcess`.
