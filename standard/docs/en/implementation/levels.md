...
The documentation on [flat CSV file serialization](../../../../implementation/serialization/#csv) of the standard may be useful for those seeking to publish at this level.
