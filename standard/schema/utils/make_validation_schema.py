...
def get_versioned_validation_schema(versioned_release):
    ...
    versioned_validation_schema["id"] = "https://raw.githubusercontent.com/open-contracting/standard/master/standard/schema/versioned-release-validation-schema.json"  # nopep8
