...
1. **Parity**: For each publisher, for the _time period_ and _buyers_ covered by the data, there isn't another dataset by the same publisher that covers more than 25% more contracting (or planning) processes.
