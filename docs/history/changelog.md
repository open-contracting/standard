...
* `documentType.csv`:
  ...
  * [#1464](https://github.com/open-contracting/standard/pull/1464) Deprecate 'eligibilityCriteria', add 'exclusionGrounds' and 'selectionCriteria'; remove the recently added 'economicSelectionCriteria' and 'technicalSelectionCriteria'.
