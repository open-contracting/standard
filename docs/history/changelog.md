...
* [#1531](https://github.com/open-contracting/standard/pull/1531) Update wording on change history. Add guidance on change history options. Add a working example on no change history.
