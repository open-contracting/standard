...
* [#1209](https://github.com/open-contracting/standard/pull/1209) Replace "electronic goods" with "digital goods" in the description of `goods` from the `procurementCategory` codelist, to prevent the confusion with electronic devices such as laptops.
