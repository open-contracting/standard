...
* Add new fields:
  ...
  * [#1335](https://github.com/open-contracting/standard/pull/1335) `id` to `Planning`
...
* Update and clarify field descriptions:
  ...
  * [#1335](https://github.com/open-contracting/standard/pull/1335) Standardize the descriptions of `planning`, `planning.rationale`, `planning.budget`, `planning.documents`, `planning.milestones`
