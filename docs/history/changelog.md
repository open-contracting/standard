...
* Guidance section:
  * [#1216](https://github.com/open-contracting/standard/pull/1216) Add "Contracting and planning processes" section to the Mapping the hard cases of the Guidance. Rename "unsuccessful procedures" and "pre-qualification". Minor updates in other parts of the documentation. 
