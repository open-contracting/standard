...
See the [full worked example](../../guidance/model/organization_identifiers) for more information on implementing identifiers from these different kinds of organization lists.
